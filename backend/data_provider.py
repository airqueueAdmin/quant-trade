...
POPULAR_US_STOCKS = (
    ...
    {"ticker": "SKHY", "name": "SK hynix ADR", "exchange": "NASDAQ", "aliases": ["SK하이닉스", "SK 하이닉스", "에스케이하이닉스", "하이닉스"]},
    {"ticker": "AMZN", "name": "Amazon.com, Inc.", "exchange": "NASDAQ", "aliases": ["아마존"]},
    {"ticker": "GOOGL", "name": "Alphabet Inc.", "exchange": "NASDAQ", "aliases": ["알파벳", "구글"]},
    {"ticker": "META", "name": "Meta Platforms, Inc.", "exchange": "NASDAQ", "aliases": ["메타", "페이스북"]},
    {"ticker": "TSLA", "name": "Tesla, Inc.", "exchange": "NASDAQ", "aliases": ["테슬라"]},
    {"ticker": "AVGO", "name": "Broadcom Inc.", "exchange": "NASDAQ", "aliases": ["브로드컴"]},
    {"ticker": "AMD", "name": "Advanced Micro Devices, Inc.", "exchange": "NASDAQ", "aliases": ["에이엠디"]},
    {"ticker": "QCOM", "name": "Qualcomm Incorporated", "exchange": "NASDAQ", "aliases": ["퀄컴"]},
    {"ticker": "MU", "name": "Micron Technology, Inc.", "exchange": "NASDAQ", "aliases": ["마이크론"]},
    {"ticker": "ARM", "name": "Arm Holdings plc", "exchange": "NASDAQ", "aliases": ["암홀딩스", "ARM 홀딩스"]},
    {"ticker": "TSM", "name": "Taiwan Semiconductor Manufacturing Company Limited", "exchange": "NYSE", "aliases": ["TSMC", "대만반도체", "타이완반도체"]},
    {"ticker": "ASML", "name": "ASML Holding N.V.", "exchange": "NASDAQ", "aliases": ["에이에스엠엘"]},
    {"ticker": "AMAT", "name": "Applied Materials, Inc.", "exchange": "NASDAQ", "aliases": ["어플라이드머티리얼즈"]},
    {"ticker": "LRCX", "name": "Lam Research Corporation", "exchange": "NASDAQ", "aliases": ["램리서치"]},
    {"ticker": "PLTR", "name": "Palantir Technologies Inc.", "exchange": "NASDAQ", "aliases": ["팔란티어"]},
    {"ticker": "ORCL", "name": "Oracle Corporation", "exchange": "NYSE", "aliases": ["오라클"]},
    {"ticker": "CRM", "name": "Salesforce, Inc.", "exchange": "NYSE", "aliases": ["세일즈포스"]},
    {"ticker": "ADBE", "name": "Adobe Inc.", "exchange": "NASDAQ", "aliases": ["어도비"]},
    {"ticker": "NOW", "name": "ServiceNow, Inc.", "exchange": "NYSE", "aliases": ["서비스나우"]},
    {"ticker": "CRWD", "name": "CrowdStrike Holdings, Inc.", "exchange": "NASDAQ", "aliases": ["크라우드스트라이크"]},
    {"ticker": "PANW", "name": "Palo Alto Networks, Inc.", "exchange": "NASDAQ", "aliases": ["팔로알토", "팔로알토네트웍스"]},
